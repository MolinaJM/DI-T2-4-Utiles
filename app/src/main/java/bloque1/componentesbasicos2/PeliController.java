...
public class PeliController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        //como cualquier Node, es personalizable (tema 3)
        ...
        colorPicker.setOnAction(e -> {
            ...
            //Hacemos algo nuevo, acceso al Scene para recorrer todos los nodos y cambiar el color
            for (Node node : movieTitle.getScene().getRoot().getChildrenUnmodifiable()) {
        ...
        movieLink.setOnAction(e -> {
            ...
            //Se le indica un UserAgent válido, por si tiene restricciones CORS la web que consultamos
            //El UserAgent es una cadena de texto que identifica al navegador o aplicación que está solicitando una página web al servidor.
            //Ej: UserAgent de Chrome
        ...
        //Por último, utilizamos una combinación de teclas mediante el objeto KeyCodeCombination
